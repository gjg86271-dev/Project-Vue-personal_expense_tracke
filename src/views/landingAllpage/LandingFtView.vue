                            ...
                            <div class="d-flex justify-content-between">
                                <div class="card-title">
                                    <h1 class="title-hero fw-bold" style="font-size: 64px;">
                                        រៀបចំកាលចំណាយ<br>
                                        <span class="text-primary">របស់អ្នក</span><br>
                                        អោយល្អប្រសើរ
                                    </h1>
                                    <div class="card-text">
                                        <p class="text-secondary">បង្វែរភាពស្មុគស្មាញឱ្យទៅជាភាពងាយស្រួល។ <span
                                                class="text-success fw-bold"> កាក់សេន </span> ជួយអ្នកតាមដានរាល់កាលចំណាយ
                                    ...
                                    <div class="card-title ">
                                        ...
                                        <div class="card-text p-3">
                                            <p class="text-secondary"><span class="text-success fw-bold"> កាក់សេន
                                                </span> គឺជាកម្មវិធីគ្រប់គ្រងហិរញ្ញវត្ថុផ្ទាល់ខ្លួន
                                    ...
                                    <div class="card-title">
                                        ...
                                        <div class="card-text">
                                            <p class="text-secondary"><span
                                                ...
                                                ដោយមិនចាំបាច់ស្វែងរកព័ត៌មានបន្ថែម។
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-title">
                                        <div class="card-icon p-3 bg-primary-subtle rounded-3 mb-3"
                                            ...
                                            <svg width="40" height="40" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <path d="M16 8v12m0 0l-3-3m3 3l3-3" stroke="currentColor"
...
.hero-section {
    background: linear-gradient(135deg, #e0f7f4, #e8f4ff, #f0faf4);
}
